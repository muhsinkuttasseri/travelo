                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" name="contact" class="button button-contactForm boxed-btn">Send</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>+917012813561</h3>
                                <p>24/7 call Assistance</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>medplustour@gmail.com</h3>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3> <a href="whatsapp://send/?phone=917010813561">WhatsApp</a></h3>
                                <p><a hrer="#">+917012813561</a></p>
                            </div>
                        </div>
                </div>
            </div>
