...
<body>
    ...
    <div class="section-top-border">
        ...
        <h3 class="mb-30">Table travel query</h3>
        <div class="progress-table-wrap" style="overflow: hidden;">
            <div class="progress-table">
                <div class="table-head">
                    <div class="serial">#</div>
                    <div class="country">Destination</div>
                ...
                <?php
                    ...
                    $sql = "SELECT place, date, phone FROM travel_query;";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<div class='table-row'>
                                ...
                                <div class='country'>". $row['place']."</div>
                                <div class='visit'>". $row['date']."</div>
                                <div class='percentage'> ". $row['phone']." </div>
                            </div>";   
                        }
                    } else {
                        echo "0 results";
