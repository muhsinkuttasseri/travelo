...
<body>
    ...
    <div class="section-top-border">
        ...
        <h3 class="mb-30">User List Table</h3>
        <div class="progress-table-wrap" style="overflow: hidden;">
            <div class="progress-table">
                ...
                <?php
                    ...
                    $sql = "SELECT id, fname, lname, email, uname, dob FROM user;";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<div class='table-row'>
                                ...
                                <div class='visit'>".$row['fname'] ."</div>
                                <div class='visit'>".$row['lname'] ."</div>
                                <div class='visit'>".$row['email'] ."</div>
                                <div class='visit'>".$row['uname'] ."</div>
                                <div class='visit'>".$row['dob'] ."</div>
                            </div>";   
                        }
                    } else {
                        echo "0 results";
