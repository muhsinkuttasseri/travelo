                                ...
                                <div class="social_wrap d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="social_links d-none d-xl-block">
                                        <ul>
                                            ...
                                            <li><a href="https://www.linkedin.com/in/muhsin-kuttasseri-69489216a/?originalSubdomain=in"> <i class="fa fa-linkedin"></i> </a></li>
                ...
                <div class="col-lg-9">
                    <div class="search_wrap">
                        <form class="search_form">
                            ...
                            <div class="input_field">
                                <input type="text" id="phonephone" name="phone" placeholder="Phone No.">
                            </div>
                            <div class="search_btn">
                                <button class="boxed-btn4" id="submit_travel_query" >Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="destination_details.php"><h3>Athirapally</h3></a>
                            <p>Kerala, India</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="destination_details.php"><h3>Lakswa Dweep</h3></a>
                            <p>kerala, India</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="destination_details.ph"><h3>Taj Mahal</h3></a>
                            <p>Aghra, India</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="destination_details.php"><h3>Andaman Island</h3></a>
                            <p>Andaman, India</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="destination_details.php"><h3>Varanasi</h3></a>
                            <p>Karnadaka, India</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        ...
                        <div class="place_info">
                            <a href="destination_details.php"><h3>Goa</h3></a>
                            <p>Goa, India</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <p>The mind should be allowed some relaxation, that it may return to its work all the better for the rest</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>Travel Guide</h3>
                        <p>We provide personal Trip peersonal Guid.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <p>Get your visa to all over the contry's with in hours.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>TAXI assistance</h3>
                        <p>Book Your Cab now with low cost.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <p>We help you to exchage all currencys all over the world.</p>
                    </div>
                </div>
            </div>
        </div>
...
<!--     
    ...
    <script>
        ...
        $('#submit_travel_query').click(function(){

            $.ajax({
                type: 'POST',
                url: "travel_query.php",
                dataType: "json",
